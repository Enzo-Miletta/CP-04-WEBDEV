    ...
    return(
        ...
        <div key={id} className="flex flex-col text-center justify-center items-center flex-shrink-0 relative">
            {/* <h2 className="font-semibold">{title || titulo}</h2> */}
              ...
              <Link className="py-2 px-3 transition ease-in-out duration-300 bg-blue-700 hover:bg-white hover:text-blue-700 m-4 text-white rounded-3xl" to={`/movies/${id}`}>Ver detalhes</Link>
        </div>
        </>
    )
